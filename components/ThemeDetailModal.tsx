            ...
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl bg-white shadow-xl animate-in zoom-in-95 duration-200">
                ...
                <div className="overflow-y-auto max-h-[90vh]">
                    ...
                    <div className="p-6">
                        ...
                        {/* Scores */}
                        <div className="mb-6">
                            <h3 className="mb-3 text-sm font-bold text-gray-900">점수</h3>
                            <div className="space-y-3">
                                <ScoreItem label="난이도" score={theme.difficulty} icon={Star} colorClass="text-yellow-500" bgClass="bg-yellow-500" />
                                <ScoreItem label="공포도" score={theme.fear} icon={Ghost} colorClass="text-purple-500" bgClass="bg-purple-500" />
                                <ScoreItem label="활동성" score={theme.activity} icon={Activity} colorClass="text-blue-500" bgClass="bg-blue-500" />
                                <ScoreItem label="추천도" score={theme.recommendation} icon={ThumbsUp} colorClass="text-green-500" bgClass="bg-green-500" />
                            </div>
                        </div>
                        ...
                        {theme.websiteUrl && (
                            <a
                                ...
                                className="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-700"
                            >
